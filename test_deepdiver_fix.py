#!/usr/bin/env python3
"""
Test script to verify the DeepDiver alignment fix
"""
...
def test_deepdiver_alignment():
    """Test the fixed DeepDiver style alignment"""
    
    print("🧪 Testing DeepDiver alignment fix...")
    ...
    # Output path
    output_file = output_dir / "deep_diver_FIXED_alignment.mp4"
    
    # Render video
    print(f"🎯 Rendering fixed DeepDiver to {output_file}")
    composition.write_video(str(output_file), codec='libx264', fps=30)
    print(f"✅ DeepDiver alignment fix test completed!")
    
    return True

if __name__ == "__main__":
    test_deepdiver_alignment()