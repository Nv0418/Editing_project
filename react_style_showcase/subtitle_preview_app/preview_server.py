...
def generate_preview():
    try:
        ...
        cmd = [
            'python3',
            os.path.join(os.path.dirname(__file__), '..', 'style_preview_generator.py'),
            '--style', style,
            '--text', text
        ]
        ...
        preview_path = os.path.join(os.path.dirname(__file__), '..', 'style_previews', preview_filename)
...
def serve_preview(filename):
    ...
    preview_path = os.path.join(os.path.dirname(__file__), '..', 'style_previews', filename)
