#!/usr/bin/env python3
"""Test karaoke style with real parakeet timing data and audio"""
...
def test_karaoke_with_real_timing():
    """Test karaoke style with real timing data and black background"""
    ...
    output_path = "/Users/naman/Desktop/movie_py/output_test/karaoke_yellow_real_timing.mp4"
    ...
    # Export settings
    print(f"\\nRendering karaoke style video with:")
    print(f"- Font: Bebas Neue (108px - 50% bigger)")
